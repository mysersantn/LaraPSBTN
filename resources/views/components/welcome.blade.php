<div>
    ...
    <div class="mt-8 grid grid-cols-3 gap-4">
        <div class="bg-gradient-to-r from-blue-200 to-blue-300 sm:rounded-lg flex gap-4 px-4 py-8 shadow-md">
            <div class="text-gray-900 font-bold text-xl"><i class="fa-sharp fa-solid fa-file"></i></div>
            <div class="text-gray-900 font-bold text-xl">Pasang Baru</div>
            <div class="text-gray-900 font-bold text-xl">0</div>
        </div>
        <div class="bg-gradient-to-r from-blue-200 to-blue-400 sm:rounded-lg flex gap-4 px-4 py-8 shadow-md">
            <div class="text-gray-900 font-bold text-xl"><i class="fa-sharp fa-solid fa-file"></i></div>
            <div class="text-gray-900 font-bold text-xl">Air Bersih</div>
            <div class="text-gray-900 font-bold text-xl">0</div>
        </div>
        <div class="bg-gradient-to-r from-blue-200 to-blue-600 sm:rounded-lg flex gap-4 px-4 py-8 shadow-md">
            <div class="text-gray-900 font-bold text-xl"><i class="fa-sharp fa-solid fa-file"></i></div>
            <div class="text-gray-900 font-bold text-xl">Air Limbah</div>
            <div class="text-gray-900 font-bold text-xl">0</div>
        </div>
    </div>

    <div class="mt-8 grid grid-cols-4 gap-4">
        <div class="bg-orange-200 sm:rounded-lg">Jumlah Permintaan</div>
        <div class="bg-green-200 sm:rounded-lg">Jumlah Survey</div>
        <div class="bg-blue-200 sm:rounded-lg">Jumlah Bayar</div>
        <div class="bg-yellow-200 sm:rounded-lg">Jumlah Terpasang</div>
    </div>

    <div>
        <button class="px-6 py-2 bg-blue-700 rounded-md mt-2 text-white hover:bg-green-700"><i class="fa-sharp fa-solid fa-file mr-4"></i>Klik Here</button>
    </div>
</div>
