<div>
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200 sm:rounded-lg">
    ...
    <div class="mt-8 grid sm:grid-cols-3 gap-4">
        <div class="bg-blue-900 sm:rounded-lg flex justify-center gap-4 px-4 py-8 shadow-md">
            <div class="text-white font-bold text-xl"><i class="fa-solid fa-user-plus"></i></div>
            <div class="text-white font-bold text-xl">Pasang Baru</div>
            <div class="text-white font-bold text-xl">0</div>
        </div>
        <div class="bg-blue-900 sm:rounded-lg flex justify-center gap-4 px-4 py-8 shadow-md">
            <div class="text-white font-bold text-xl"><i class="fa-solid fa-water"></i></div>
            <div class="text-white font-bold text-xl">Air Bersih</div>
            <div class="text-white font-bold text-xl">0</div>
        </div>
        <div class="bg-blue-900 sm:rounded-lg flex justify-center gap-4 px-4 py-8 shadow-md">
            <div class="text-white font-bold text-xl"><i class="fa-solid fa-dumpster"></i></div>
            <div class="text-white font-bold text-xl">Air Limbah</div>
            <div class="text-white font-bold text-xl">0</div>
        </div>
    </div>

    <div class="mt-8 grid sm:grid-cols-4 gap-4">
        <div class="bg-white sm:rounded-lg flex justify-center gap-4 px-4 py-8 shadow-md border-l-8 border-blue-900">
            <div class="text-blue-900 font-bold text-xl"><i class="fa-solid fa-hand-holding-droplet"></i></div>
            <div class="text-blue-900 font-bold text-xl">Jumlah Permintaan</div>
            <div class="text-blue-900 font-bold text-xl">0</div>
        </div>
        <div class="bg-white sm:rounded-lg flex justify-center gap-4 px-4 py-8 shadow-md border-l-8 border-blue-900">
            <div class="text-blue-900 font-bold text-xl"><i class="fa-solid fa-square-poll-vertical"></i></div>
            <div class="text-blue-900 font-bold text-xl">Jumlah Survey</div>
            <div class="text-blue-900 font-bold text-xl">0</div>
        </div>
        <div class="bg-white sm:rounded-lg flex justify-center gap-4 px-4 py-8 shadow-md border-l-8 border-blue-900">
            <div class="text-blue-900 font-bold text-xl"><i class="fa-solid fa-money-bill-wave"></i></div>
            <div class="text-blue-900 font-bold text-xl">Jumlah Bayar</div>
            <div class="text-blue-900 font-bold text-xl">0</div>
        </div>
        <div class="bg-white sm:rounded-lg flex justify-center gap-4 px-4 py-8 shadow-md border-l-8 border-blue-900">
            <div class="text-blue-900 font-bold text-xl"><i class="fa-solid fa-faucet"></i></div>
            <div class="text-blue-900 font-bold text-xl">Jumlah Terpasang</div>
            <div class="text-blue-900 font-bold text-xl">0</div>
        </div>
    </div>
            ...
            <script>
                ...
                const dataBarChart = {
                    ...
                    datasets: [{
                        ...
                        borderColor: "#172554",
                        data: [1, 10, 5, 2, 20, 17, 25, 5, 6, 8, 6, 20],
                    }, ],
                };
