@section('title', 'Master Rekanan')
<div>
    @if ($createMode)
        @include('livewire.masters.rekanan.master-rekanan-create')
    @endif
    @if ($updateMode)
        @include('livewire.masters.rekanan.master-rekanan-update')
    @endif
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Master
                                Rekanan</span>
                        </div>
                    </li>
                </ol>
                    ...
                    <div class="flex items-center justify-between pb-4">
                        <div>
                            <button wire:click="create()"
                                class="bg-blue-800 rounded-lg text-white py-1 px-4 hover:bg-blue-950"><i
