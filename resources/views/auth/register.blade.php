    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <select id="kocab" name="kocab" :value="old('kocab')" required autocomplete="kocab"
                    class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                    <option selected>Choose a Cabang</option>
            ...
            <div class="mt-4">
                ...
                <x-input id="role" class="block mt-1 w-full" type="text" name="role" :value="old('role')"
